...
BEGIN_SEND_TABLE_NOBASE( CPlayerLocalData, DT_Local )
	...
	SendPropInt		(SENDINFO(m_iPlayerCash), -1, SPROP_UNSIGNED),
...
BEGIN_SIMPLE_DATADESC( CPlayerLocalData )
	...
	DEFINE_FIELD( m_iPlayerCash, FIELD_INTEGER ),
	DEFINE_FIELD( m_iArmorUpgrades, FIELD_INTEGER),
	DEFINE_FIELD( m_iHealthUpgrades, FIELD_INTEGER),
	DEFINE_FIELD(m_iArmorSegmentUpgrades, FIELD_INTEGER),
	DEFINE_FIELD(m_iHealthSegmentUpgrades, FIELD_INTEGER),
	DEFINE_FIELD( m_iGrabbed357, FIELD_INTEGER ),
	DEFINE_FIELD( m_iGrabbedAR2, FIELD_INTEGER ),
