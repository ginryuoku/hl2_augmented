...
class CWeaponMP5K : public CHLMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponMP5K, CHLMachineGun);
	...
	float	GetFireRate(void) { return 0.066f; }	// 15hz, 900rpm
...
LINK_ENTITY_TO_CLASS(weapon_smg_mp5k, CWeaponMP5K);
PRECACHE_WEAPON_REGISTER(weapon_smg_mp5k);
...
void CWeaponMP5K::PrimaryAttack()
{
