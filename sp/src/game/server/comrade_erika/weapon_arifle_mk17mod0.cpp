...
class CWeaponMK17STD : public CHLMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponMK17STD, CHLMachineGun);
...
IMPLEMENT_SERVERCLASS_ST(CWeaponMK17STD, DT_WeaponMK17STD)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_arifle_mk17mod0, CWeaponMK17STD);
PRECACHE_WEAPON_REGISTER(weapon_arifle_mk17mod0);

BEGIN_DATADESC(CWeaponMK17STD)
DEFINE_FIELD(m_bIsSuppressed, FIELD_BOOLEAN),
END_DATADESC()

acttable_t	CWeaponMK17STD::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponMK17STD);

//=========================================================
CWeaponMK17STD::CWeaponMK17STD()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMK17STD::Precache(void)
{
	BaseClass::Precache();
}
...
//-----------------------------------------------------------------------------
void CWeaponMK17STD::Equip(CBaseCombatCharacter *pOwner)
{
...
void CWeaponMK17STD::DryFire(void)
{
	WeaponSound(EMPTY);
	if (m_bIsSuppressed) {
...
void CWeaponMK17STD::PrimaryAttack(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMK17STD::SecondaryAttack(void)
{
	DisableIronsights();
	if (m_bIsSuppressed)
	{
...
void CWeaponMK17STD::WeaponIdle(void)
{
	if (m_bIsSuppressed) {
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMK17STD::FireNPCPrimaryAttack(CBaseCombatCharacter *pOperator, Vector &vecShootOrigin, Vector &vecShootDir)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMK17STD::Operator_ForceNPCFire(CBaseCombatCharacter *pOperator, bool bSecondary)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMK17STD::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	switch (pEvent->event)
	{
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponMK17STD::GetPrimaryAttackActivity(void)
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool CWeaponMK17STD::Reload(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMK17STD::AddViewKick(void)
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CWeaponMK17STD::GetProficiencyValues()
{
...
bool CWeaponMK17STD::Deploy(void)
{
	if (m_bIsSuppressed)
	{
...
float CWeaponMK17STD::GetFireRate(void)
{
	if (m_bIsSuppressed)
	{
		return 0.096f; // 10.417hz, 625rpm
	}
	else
	{
		return 0.096f; // 10.417hz, 625rpm
